...
#	- Changed Default Apps to Notepad++, Brave, Irfanview, and more using XML Import feature (Removed by Gameless due to new browsers)
#
#	Gameless Additions:
#
#	- Pick Browser
...
Function InstallBrowser {
 ...
 {
    Clear-Host
    Write-Host "================ What browser would you like to use? ================"
	...
	'f' { choco install firefox	-y }
	'c' { choco install googlechrome -y }
    'n' { Break }
    'q' { Exit  }
    }
 }
 until ($selection -match "b" -or $selection -match "f" -or $selection -match "c" -or $selection -match "s" -or $selection -match "q" )
